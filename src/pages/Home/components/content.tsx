  ...
  render(){
    return(
        <div className="tabHome">
          ...
          <footer className="homeFt">
            <div className="ftWrap">
              <div className="logo">
                <svg className="logoSvg" viewBox="0 0 1238 231" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="recommond_logo">
                      ...
                      <g id="Group">
                        <g transform="translate(288.000000, 31.000000)">
                          ...
                          <polygon id="Shape"
                                   points="654.29 60.29 687.611 60.29 704.865 30.004 637.037 30.004"></polygon>
                          ...
                          <polygon id="Shape"
                                   points="623.569 102.427 623.569 120.946 718.398 120.946 718.398 116.754 718.398 102.427 704.931 102.427"></polygon>
                          <path
                              ...
                              id="Shape" fill="#001317" fillRule="nonzero"></path>
                          <path
